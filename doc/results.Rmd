...
- protein: binary variable whose value is 1 if the species is carnivorous
...
This is to determine whether there's an effect of body mass on SEF.
It appears there is not.

```{r results-sef-clade-mass, echo = TRUE, cache = TRUE}
...
influential to the results, which makes us less confident in the conclusions from the
full dataset.
