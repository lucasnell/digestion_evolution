...
$\lambda$, estimates a very strong phylogenetic signal (Table \ref{tab:prox-summs}).
...
Table \ref{tab:re-run-summ-dfs} compares summaries of this model 
...
Tables \ref{tab:clear-sef-kable}, \ref{tab:clear-ed-kable}, and \ref{tab:absorp-te-kable}
