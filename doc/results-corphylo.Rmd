...
rerun_df <- data_frame(parameter = c('$r$', '$d_{\\text{sef}}$', 
                       ...
                       estimate = c(influence_rerun$corrs[1,2], 
                                    influence_rerun$d),
                       lower = c(boot_ci(influence_rerun)$corrs[2,1],
                                 boot_ci(influence_rerun)$d[,'lower']),
                       upper = c(boot_ci(influence_rerun)$corrs[1,2],
                                 boot_ci(influence_rerun)$d[,'upper']),
                       P = c(pval(influence_rerun, "corrs")[1,2], rep("–", 2)))
rerun_df %>% 
    pretty_df(., caption = str_c('\\texttt{cor\\_phylo} model summary for the ',
                                 'correlation between clearance and SEF ',
