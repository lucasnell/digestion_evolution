...
I also created one data set each from `output/clean_clearance_data.csv` and
`output/clean_absorption_data.csv`.
These csvs are found in `output/clear_df.csv` and `output/absorp_df.csv`, respectively.
...
The analysis sets are as follows:
